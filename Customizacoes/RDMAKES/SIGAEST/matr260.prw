...
IndRegua(cAliasTRB,cAliasTRB,cIndxKEY,,,"Organizando Arquivo...")   //"Organizando Arquivo..."
...
cCab01 :=                             "CODIGO      TP GRUP DESCRICAO                    UM FL ALM   SALDO       EMPENHO PARA       ESTOQUE        ___________V A L O R___________"
cCab02 :=                             "                                                             EM ESTOQUE  REQ/PV/RESERVA     DISPONIVEL      EM ESTOQUE          EMPENHADO "
	...
	If ( (mv_par14 == 1)  .Or.;
		...
		If lPrintDET .Or. lPrintTOT
			...
			If lPrintCAB .Or. lPrintOUT
				...
				@ Li,013 + nCOL1 PSay aPrnDET[ DET_TIPO ]
				@ Li,016 + nCOL1 PSay aPrnDET[ DET_GRUP ]
				@ Li,021 + nCOL1 PSay aPrnDET[ DET_DESC ]
				@ Li,050 + nCOL1 PSay aPrnDET[ DET_UM   ]
				
				lPrintCAB := .F. ; lPrintOUT := .F.
			EndIf
			
			@ Li,053 + nCOL1 PSay aPrnDET[ DET_FL   ]
			@ Li,056 + nCOL1 PSay aPrnDET[ DET_ALMX ]
	
			@ Li,058 + nCOL1 PSay aPrnDET[ DET_SALD ] Picture cPicture
			@ Li,074 + nCOL1 PSay aPrnDET[ DET_EMPN ] Picture cPicture
			@ Li,089 + nCOL1 PSay aPrnDET[ DET_DISP ] Picture cPicture
			@ Li,104 + nCOL1 PSay aPrnDET[ DET_VEST ] Picture cPicVal
			@ Li,123 + nCOL1 PSay aPrnDET[ DET_VEMP ] Picture cPicVal
	        If mv_par23 == 1
		        @ Li,140 + nCOL1 PSay aPrnDET[ DET_DEAL ]
	        EndIf
