...
@ 100, 100 To 240, 670 Dialog oDlg Title "Financeiro" 
@ 10, 10 SAY "Duplicata:" 
@ 10, 60 SAY SE2->E2_NUM + "/" + AllTrim(SE2->E2_PREFIXO) +   " - " + SE2->E2_PARCELA + ;
			"    Vencto: " + DToC(SE2->E2_VENCTO) + "      Valor: " + AllTrim(Transform(SE2->E2_VALOR, "@E 999,999,999.99"))
@ 25, 10 SAY "Fornecedor:" 
@ 25, 60 SAY AllTrim(SE2->E2_FORNECE) + "/" + SE2->E2_LOJA + " - " + ;
							AllTrim(Posicione("SA2", 01, xFilial("SA2") + SE2->E2_FORNECE + SE2->E2_LOJA, "A2_NOME"))
@ 40, 10 SAY "Forma Pagamento:"
@ 40, 60 GET cFormPg Size 40, 40 PICTURE "@!" F3 "24" VALID ExistCpo("SX5","24"+cFormPg)
