...
/*
oReport:SkipLine()
oReport:PrintText("Base Solidário ->" + Transform(xBaseSol,"9,999,999.99") ,2190,30)	// "PESO BRUTO ------>"
oReport:PrintText("Valor Solidário ->"  + Transform(xValSol,"9,999,999.99"),2200,600)	// "PESO LIQUIDO ---->"
*/
...
If cPaisLoc == "BRA"
	...
	TRCell():New(oImpostos,"NF_BASESOL"	,/*Tabela*/,STR0091,PesqPict("SF2","F2_BRICMS") ,TamSx3("F2_BRICMS"		)[1],/*lPixel*/,{|| MaFisRet(,"NF_BASESOL")+xBaseSol 	})	// "Base Retido"
	TRCell():New(oImpostos,"NF_VALSOL"	,/*Tabela*/,STR0092,PesqPict("SF2","F2_ICMSRET"),TamSx3("F2_ICMSRET"		)[1],/*lPixel*/,{|| MaFisRet(,"NF_VALSOL"	)+xValSol 	})	// "Valor Retido"
...
if SC5->C5_TIPOCLI == "F" .and. !Empty(sa1->a1_inscr) .and. SF4->F4_ICM=="S"
	...
	If nAliqInt <> nPerIcm2
		_NBSOLI := aItemPed[nItem][13]+nValImp
...
oReport:PrintText("Atenção, foi gerado base de retenção e imposto pois as aliquotas internas e externas são diferentes e o cliente é do tipo final e não possui inscriçao estadual" ,2190,30)	// "PESO BRUTO ------>"
//oReport:PrintText("Valor Solidário ->"  + Transform(xValSol,"9,999,999.99"),2200,600)	// "PESO LIQUIDO ---->"
