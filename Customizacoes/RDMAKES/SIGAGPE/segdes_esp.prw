...
ฑฑษอออออออออออออัอออออออออหอออออออัออออออออออออออออออออหออออออัออออออออออออปฑฑ
ฑฑบPrograma     ณSEGDES   บAutor  ณMicrosiga           บ Data ณ  10-01-02  บฑฑ
ฑฑฬอออออออออออออุอออออออออสอออออออฯออออออออออออออออออออสออออออฯออออออออออออนฑฑ
ฑฑบDesc.        ณRequerimento de Seguro-Desemprego - S.D.	 	 	 	   บฑฑ
ฑฑฬอออออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso          ณAP6                                                       บฑฑ
ฑฑฬอออออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบ			     	ATUALIZACOES OCORRIDAS	         	 	 	 	       บฑฑ
ฑฑฬฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤยฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑบProgramador  ณData    ณ BOPS ณ  Motivo da Alteracao                     ณฑฑ
ฑฑฬฤฤฤฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤลฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑบPriscila     ณ30/09/02ณ015780ณAjuste p/ Impressao, qdo Cal.Resc. mes se ณฑฑ
...
ฑฑบPriscila     ณ15/05/03ณ063264ณAjuste p/ trazer correto os valores dos 3 ณฑฑ
ฑฑบ             ณ        ณ      ณultimos salarios.                         ณฑฑ
ฑฑบSilvia       ณ30/09/03ณ066800ณAjuste no calculo dos 3 ult.salario       ณฑฑ
...
ฑฑบ             ณ17/08/04ณ073442ณTroca da fSomaAcl por fBuscaAcm- verifica ณฑฑ
ฑฑบ             ณ        ณ------ณas transf. do funcionario                 ณฑฑ
ฑฑบ             ณ13/09/04ณ------ณNovo lay-out - Resol. 393/2004            ณฑฑ
ฑฑบ             ณ15/02/05ณ075395ณFaz a impressao dos salarios juntamente   ณฑฑ
ฑฑบ             ณ        ณ------ณcom as verbas incorporadas -Busca id 318  ณฑฑ
ฑฑบPedro Eloy   ณ13/07/05ณSADVLQณAjuste no retorno do campo SRA->RA_SerCp  ณฑฑ
ฑฑบ             ณ        ณ------ณbusca a serie da carteira trabalhista.    ณฑฑ
ฑฑบ             ณ29/07/05ณ082433ณImpressao do campo telefone do Funcion.   ณฑฑ
ฑฑบRicardo D.   ณ05/01/06ณ090269ณAjuste na pesquisa do penultimo salario noณฑฑ
ฑฑบ             ณ        ณ      ณcaso em que a demissao ocorrer no mes se- ณฑฑ
ฑฑบ             ณ        ณ      ณguinte ao mes aberto.                     ณฑฑ
ฑฑบTania/Ricardoณ22/02/06ณ092668ณAcerto para impressao das verbas no acumu-ณฑฑ
ฑฑบ             ณ        ณ      ณlado quando em Top.                       ณฑฑ
ฑฑบNatie        ณ04/07/06ณ101533ณAjuste na impressao do cpo Endereco       ณฑฑ
ฑฑบNatie        ณ28/11/06ณ111215ณAjuste na impressao do Cep qdo nao havia  ณฑฑ
ฑฑบ             ณ        ณ      ณimpressao de complemento  de endereco     ณฑฑ
ฑฑบPedro Eloy   ณ01/06/07ณ126187ณTratamento na emissao do aviso indenizado.ณฑฑ
ฑฑบNatie        ณ06/06/07ณ096700ณAjuste na composicao dos meses trabalhadosณฑฑ
ฑฑบMarcelo      ณ20/01/09ณ155069ณConversao p/ permitir impressao em formatoณฑฑ
ฑฑบ             ณ        ณ      ณgrafico. Inclusao das funcoes: AjustaSX e ณฑฑ
ฑฑบ             ณ        ณ      ณfIncSpace.                                ณฑฑ
ฑฑบMarcelo      ณ06/03/09ณ004737ณCriacao de pergunta p/definir se as verbasณฑฑ
ฑฑบ             ณ        ณ  2009ณinformadas serao somadas no ultimo salarioณฑฑ
ฑฑบMarcelo      ณ27/05/09ณ013064ณAjuste em fSegDes para considerar sempre aณฑฑ
ฑฑบ             ณ        ณ  2009ณdata de demissao na apuracao dos meses    ณฑฑ
ฑฑบ             ณ        ณ      ณtrabalhados.                              ณฑฑ
ฑฑศอออออออออออออฯออออออออฯออออออฯออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿*/
...
//+--------------------------------------------------------------+
WnRel :=SetPrint(cString,WnRel,cPerg,cTit,cDesc1,cDesc2,cDesc3,.F.,aOrd,.T.,'M')
...
//ฆ** Inicio da Impressao do Requerimento de Seguro-Desemprego **ฆ
//+--------------------------------------------------------------+
@ nLinha, nColIni-3 PSAY  fPluSpace( cNome ) 
nLinha	+= 3 
@ nLinha, nColIni-3 PSAY  fPluSpace( cMae )
nLinha	+= 3 
@ nLinha, nColIni-3 PSAY fPluSpace( cEnd )
nLinha	+= 3
@ nLinha, nColini-3    PSAY fPluSpace( cCompl )
@ nLinha, nColIni+ 27  PSAY fPluSpace( cCep )
@ nLinha, nColIni+ 47  PSAY fPluSpace( cUF )
@ nLinha, nColIni+ 53  PSAY fPluSpace( cFone )
nLinha	+= 3 
@ nLinha, nColIni-3    PSAY fPluSpace( cPIS )
@ nLinha, nColIni+ 23  PSAY fPluSpace( cCTPS ) 
@ nLinha, nColIni+ 37  PSAY fPluSpace( cCTSerie )
@ nLinha, nColIni+ 43  PSAY fPluSpace( cCTUF )
@ nLinha, nColIni+ 51  PSAY fPluSpace( cCPF )
nLinha	+= 3
@ nLinha, nColIni+ 05  PSAY fPluSpace( cTpInsc )
@ nLinha, nColIni+ 10  PSAY fPluSpace( cCgc )
@ nLinha, nColIni+ 41  PSAY fPluSpace( cCNAE )
@ nLinha, nColIni+ 52  PSAY ' NINFA Industria de'
@ nLinha+1, nColIni+52 PSAY '  Alimentos Ltda' 
@ nLinha+2, nColIni+52 PSAY '78.099.777/0001-42'
nLinha	+= 3
@ nLinha, nColIni-3    PSAY fPluSpace( cCBO )
@ nLinha, nColIni+ 13  PSAY cOcup 
@ nLinha, nColIni+52    PSAY 'BR 277-KM 667.4-S/N'
@ nLinha+1, nColIni+51  PSAY '   MEDIANEIRA-PR'
@ nLinha+2, nColIni+51  PSAY '   CEP:85884-000'
nLinha	+= 6
@ nLinha, nColIni-3     PSAY fPluSpace( StrZero(Day(dAdmissao),2) ) + fPluSpace( StrZero(Month(dAdmissao),2) )+ fPluSpace( Right(StrZero(Year(dAdmissao),4),2))
@ nLinha, nColIni+ 12 PSAY fPluSpace( StrZero(Day(dDemissao),2) ) + fPluSpace( StrZero(Month(dDemissao),2) )+ fPluSpace( Right(StrZero(Year(dDemissao),4),2))
@ nLinha, nColIni+ 35 PSAY fPluSpace( cSexo )
@ nLinha, nColIni+ 47 PSAY fPluSpace( cGrInstru )
@ nLinha, nColIni+ 52 PSAY fPluSpace( StrZero(Day(dNascim),2) )+ fPluSpace( StrZero(Month(dNascim),2)) + fPluSpace( Right(StrZero(Year(dNascim),4),2))
@ nLinha, nColIni+ 67 PSAY fPluSpace( cHrSemana )
nLinha	+= 3
@ nLinha, nColIni-3     PSAY fPluSpace( StrZero(Month(dDtAntSal),2))
@ nLinha, nColIni+ 02 PSAY fPluSpace( Transform(nValAntSal*100,'@E 9999999999' ))
@ nLinha, nColIni+ 22 PSAY fPluSpace( StrZero(Month(dDtPenSal),2) )
@ nLinha, nColIni+ 27 PSAY fPluSpace( Transform(nValPenSal*100,'@E 9999999999'))
@ nLinha, nColIni+ 48 PSAY fPluSpace( StrZero(Month(dDtUltSal),2) )
@ nLinha, nColIni+ 53 PSAY fPluSpace( Transform(nValUltSal*100,'@E 9999999999'))
nLinha	+= 3
@ nLinha, nColIni-3     PSAY fPluSpace( Transform( ( nValAntSal+nValPenSal+nValUltSal) *100,'@E 9999999999'))
@ nLinha, nColIni+ 69 PSAY fPluSpace( cNMeses  )
nLinha	+= 3
@ nLinha, nColIni+ 17 PSAY fPluSpace( c6Salarios)
@ nLinha, nColIni+ 36 PSAY fPluSpace( cIndeniz  )
nLinha	+= 15
@ nLinha, nColIni-3 PSAY fPluSpace( cPis )
nLinha	+= 3
@ nLinha, nColIni-3 PSAY fPluSpace( cNome ) 
@ nLinha+2, nColIni+15 PSAY 'NINFA INDUSTRIA DE ALIMENTOS LTDA'
...
oPrint:say( nLinha, nColun+0930, fIncSpace(cCep),   oFont10, 100 ) //CEP
oPrint:say( nLinha, nColun+1510, fIncSpace(cUF),    oFont10, 100 ) //UF
oPrint:say( nLinha, nColun+1680, fIncSpace(cFone),  oFont10, 100 ) //Telefone
nLinha += 150
                                                                     
oPrint:say( nLinha-05, nColun,      fIncSpace(cPIS ),    oFont10, 100 ) //Pis
oPrint:say( nLinha-05, nColun+0790, fIncSpace(cCTPS),    oFont10, 100 ) //CTPS
oPrint:say( nLinha-05, nColun+1200, fIncSpace(cCTSerie), oFont10, 100 ) //Serie CTPS
oPrint:say( nLinha-05, nColun+1380, fIncSpace(cCTUF),    oFont10, 100 ) //UF CTPS
oPrint:say( nLinha-05, nColun+1650, fIncSpace(cCPF),     oFont10, 100 ) //CPF
nLinha += 200        

oPrint:say( nLinha-50, nColun+0230, fIncSpace(cTpInsc), oFont10, 100 ) //Tipo Inscricao
oPrint:say( nLinha-50, nColun+0420, fIncSpace(cCgc),    oFont10, 100 ) //CNPJ/CEI
oPrint:say( nLinha-50, nColun+1350, fIncSpace(cCNAE),   oFont10, 100 ) //Atividade economia
nLinha += 170       

oPrint:say( nLinha-70, nColun+20,      fIncSpace( Transform(cCBO,'@R 99999 9'),  oFont10, 100 ) ) //CBO
oPrint:say( nLinha-70, nColun+0440, fIncSpace(cOcup), oFont10, 100 ) //Ocupacao
nLinha += 220  
...
oPrint:say( nLinha, nColun+0480, fIncSpace(cDtDemis),  oFont10, 100 ) //Data dispensa
oPrint:say( nLinha, nColun+1120, fIncSpace(cSexo),     oFont10, 100 ) //Sexo
oPrint:say( nLinha, nColun+1495, fIncSpace(cGrInstru), oFont10, 100 ) //Grau de instrucao
oPrint:say( nLinha, nColun+1655, fIncSpace(cDtNasci),  oFont10, 100 ) //Data nascimento
oPrint:say( nLinha, nColun+2110, fIncSpace(cHrSemana), oFont10, 100 ) //Horas trabalhadas por semana
nLinha += 160

oPrint:say( nLinha-05, nColun+15,   fIncSpace ( StrZero(Month(dDtAntSal),2) ) )  				 	//Mes antepenultimo salario
oPrint:say( nLinha-05, nColun+0230, fIncSpace ( Transform(nValAntSal*100,'@E 9999999999') ) )		//Antepenultimo salario
oPrint:say( nLinha-05, nColun+0780, fIncSpace ( StrZero(Month(dDtPenSal),2)))						//Mes penultimo salario
oPrint:say( nLinha-05, nColun+0990, fIncSpace ( Transform(nValPenSal*100,'@E 9999999999') ) )		//Penultimo salario
oPrint:say( nLinha-05, nColun+1550, fIncSpace ( StrZero(Month(dDtUltSal),2)))						//Mes ultimo salario
oPrint:say( nLinha-05, nColun+1755, fIncSpace ( Transform(nValUltSal*100,'@E 9999999999') ) )		//Ultimo salario
nLinha += 150  

nTresSal := Transform( ( nValAntSal+nValPenSal+nValUltSal) *100,'@E 9999999999') 

oPrint:say( nLinha, nColun+70,      fIncSpace (nTresSal), oFont10, 100 ) //Soma 3 ultimos salarios
oPrint:say( nLinha, nColun+2170, fIncSpace (cNMeses),  oFont10, 100 ) //Qtd meses com vinculo ultimos 36 meses
nLinha += 150  

oPrint:say( nLinha-10, nColun+0585, fIncSpace(c6Salarios), oFont10, 100 ) //Recebeu ultimos 6 meses
oPrint:say( nLinha, nColun+1150, fIncSpace(cIndeniz),   oFont10, 100 ) //Aviso previo indenizado
nLinha += 825  
                
If nNumVias == 2      
	oPrint:say( nLinha-60, nColun-05, fIncSpace(cPis),  oFont10, 100 ) //Pis 2o. Via
	nLinha += 100  
	
	oPrint:say( nLinha-15, nColun, fIncSpace(cNome), oFont10, 100 ) //Nome 2o. Via
EndIf
...
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Tratamento dos espacos para impressao no formato grafico   บฑฑ
ฑฑบ          ณ fonte Arial 10                                             บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ AP8                                                        บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
